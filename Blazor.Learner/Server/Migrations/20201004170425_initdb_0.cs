    ...
    public partial class initdb_0 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BalanceTransactions", x => new { x.BalanceId, x.TransactionId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BalanceTransactions_Transactions_TransactionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Balances_BalanceDate_AccountNumber",
                table: "Balances",
                columns: new[] { "BalanceDate", "AccountNumber" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_BalanceTransactions_TransactionId",
